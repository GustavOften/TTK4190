...
out = sim('model_autopilot_expanded', sim_time);
...
plot(out.chi_control, "r");
plot(out.delta_control, "m--")
title("Task 2e, controller performance, full model with anti-windup");
xlabel("time [s]");
ylabel("angle [deg]");
grid on;
hold off;
...
out2 = sim('model_autopilot_expanded', sim_time);
...
title("Task 2f, controller performance, full model with anti-windup");
xlabel("time [s]");
ylabel("angle [deg]");
grid on;
hold off;
...
title("Task 2f, wind up analysis full model with anti-windup");
xlabel("time [s]");
ylabel("angle [deg]");
grid on;
hold off;
